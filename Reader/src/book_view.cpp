...
/// вдвое меньше, чем у обычного переворота, — отсюда и время меньше kTurn.
/// Кривая хода та же, что у всего листания, — пологая S-кривая (kEase*).
///
...
BookView::BookView(CompositionWindow& window)
    ...
    // вёрсткой: у него нет ни переносов, ни выключки по формату — одна строка,
    // выключенная по центру, — и ради неё заводить абзац незачем.
