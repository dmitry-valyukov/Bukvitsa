...
struct TextStyle {
    ...
    /// Переносить ли слова. Без переносов выключенный русский текст набирается
    /// дырами, поэтому по умолчанию они есть; выключенные — это выбор
    /// читателя, и разбивка тогда становится терпимее к растянутой строке,
    /// потому что иначе ей нечем набрать абзац вовсе.
